#! /usr/bin/env python
"""The score_regression package setup file.
...
5. cd to score_regression and build the new dist folder:
...
URL = 'https://github.com/hrolfrc/score_regression'
LICENSE = 'new BSD'
DOWNLOAD_URL = 'https://github.com/hrolfrc/score_regression'
